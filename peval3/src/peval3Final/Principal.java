...
public class Principal extends JFrame {
	 ...
	 * Hay creados dos botones que son FTP Y EMAIL,depende del boton que pinches irás a una nueva ventana o otra.
	 * Una vez que va hacia una nueva ventana,la ventana Principal se cierra
	 */
	public Principal() {
		setResizable(false);
