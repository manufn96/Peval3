...
public class Correo {
	 ...
	 * parámetros. Se crea una instancia de la clase Properties a la cual le pasamos
	 * unos parámetros para poder establecer las propiedades de nuestro email. Se
	 * crea una instancia de la clase Session a la cual le pasamos los parámetros
	 * propiedades y una instancia de la clase Authenticator,la cual comprueba que
	 * existe ese correo con esa contraseña y devuelve una autorizacion de
	 * contraseña Se crea una instancia de la clase MimeMessage que recibe por
	 * parametro la sesion actual,luego añade a quien va destinado el mensaje,añade
	 * tambien el asunto y el cuerpo del mensaje y lo envía.
	 * 
	 ...
	 * para autentificar el correo con su contraseña y en las propiedades solo
	 ...
	 * datos del correo,la contraseña y el pop de gmail. Se crea una carpeta la cual
	 * es la carpeta principal de gmail y se abre para leer. A continuación se crea
	 * un Array de la clase Message que recibirá todos los mensajes existentes y se
	 * devuelve ese Array.
	 * 
	 * @return Message [] msg
